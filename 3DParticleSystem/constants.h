...
const int MAX_INIT_VELOCITY_X = 15;

const int MIN_INIT_VELOCITY_Y = 20;
const int MAX_INIT_VELOCITY_Y = 60;
...
const int MIN_LIFESPAN_MS = 1000;
const int MAX_LIFESPAN_MS = 3000;
